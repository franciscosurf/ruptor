...
from app.experience_analyzer import extract_experience_years
...
async def analyze_cv_logic(
    ...
    if not job_phrases:
        ...
        job_phrases = [(line, 0.50) for line in raw_lines[:25]]
    ...
    if job_phrases:
        keyword_coverage, matched_terms, missing_terms_with_context = semantic_phrase_coverage(
            cv_text, job_phrases, job_text, threshold=config.SEMANTIC_THRESHOLD
        )
    else:
    ...
    quantified_achievements_metrics = {
        ...
        "potential_points": budgets["quantified"]
    }
    ...
    # Logros adicionales para el focus
    ...
    return {
        **feedback,
        ...
        "quantified_achievements_metrics": quantified_achievements_metrics,
