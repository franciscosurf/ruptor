      ...
      <section className="relative overflow-hidden grid-bg">
        ...
        <div className="max-w-7xl mx-auto px-6 py-28 relative z-10 text-center">
          ...
          <h1 className="text-6xl md:text-7xl font-black tracking-tight leading-none mb-8">
            Planes sencillos y 
            <span className="gradient-text"> efectivos</span>
          ...
          <div className="grid lg:grid-cols-3 gap-8 items-start">
            ...
            <div className="card rounded-[32px] p-10 shadow-xl">
              <div className="mb-8">
                ...
                <h2 className="text-4xl font-black mt-3 mb-4">Gratis</h2>
            ...
            <div className="popular-card rounded-[32px] p-10 shadow-2xl">
              ...
              <div className="relative z-10">
                ...
                <p className="text-center text-sm text-white/50 mt-4">Cancela en cualquier momento. <br />Sin compromiso.</p>
              </div>
            </div>
            ...
            <div className="card rounded-[32px] p-10 shadow-xl">
              <div className="mb-8">
                ...
                <h2 className="text-4xl font-black mt-3 mb-4">Personalizado</h2>
                <div className="flex items-end gap-2 mb-4">
                  <span className="text-3xl font-black">A convenir</span>
                  <span className="text-black/40 mb-2">/mes</span>
                </div>
